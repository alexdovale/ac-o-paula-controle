...
// const assistedNameEl = document.getElementById('documents-assisted-name'); // REMOVIDO: Centralizado no cabeçalho dinâmico para evitar erros.
...
async function handleGeneratePdf() {
    ...
    try {
        ...
        const headerTitleEl = document.getElementById('documents-assisted-name-header');
        // Extrai o nome do assistido do texto do cabeçalho, removendo o prefixo
        const assistedName = headerTitleEl ? headerTitleEl.textContent.replace('Detalhes de: ', '').trim() : 'N/A';
...
export function openDetailsModal(config) {
    ...
    // A única fonte da verdade para o nome agora é o cabeçalho dinâmico.
