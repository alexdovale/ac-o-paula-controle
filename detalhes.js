...
                clonedContainer.style.overflow = 'visible';
                ...
                // Cria um elemento <style> para forçar os estilos desejados no PDF
                const style = document.createElement('style');
                style.innerHTML = `
                    /* Força o fundo do checkbox a ser branco e com borda */
                    input[type="checkbox"] {
                        background-color: #ffffff !important;
                        border: 1px solid #cccccc !important;
                    }

                    /* Força o fundo de cada item da lista (o retângulo) a ser branco */
                    #checklist-container li {
                        background-color: #ffffff !important;
                    }

                    /* Propriedade crucial para renderizar as cores de fundo no PDF */
                    input[type="checkbox"], #checklist-container li {
                        -webkit-print-color-adjust: exact !important;
                        color-adjust: exact !important;
                    }
                `;
                // Adiciona o estilo ao <head> do documento clonado
